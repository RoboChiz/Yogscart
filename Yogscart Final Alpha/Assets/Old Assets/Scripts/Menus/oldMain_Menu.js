...
var inputRect = Rect(Screen.width/20f * 2.5f,Screen.height*(1f/6f) + 10,inputWidth,Screen.height * (2f/6f));
...
if(gd.pcn[0].GetInput("Submit") == 0 && gd.pcn[0].GetInput("Cancel") == 0 )
controlLock = false;
...
if(State > 0)
if(gd.pcn[0].GetInput("Cancel") != 0 && controlLock == false)
...
if((gd.pcn[0].GetInput("Submit") != 0 || gd.pcn[0].GetInput("Cancel") != 0) && controlLock == false){
State = 6;
controlLock = true;
}
...
ScreenR += Mathf.Sign(gd.pcn[0].GetInput("Horizontal"));
...
Quality += Mathf.Sign(gd.pcn[0].GetInput("Horizontal"));
...
if(((gd.pcn[0].GetInput("Cancel") != 0 || gd.pcn[0].GetInput("Submit") != 0) && !controlLock)||creditsHeight < (Logo.height * Ratio * -9)) {
controlLock = true;
State = 1;
}
