...
//Holds the original form of the Racers.
var Racers : Racer[];
var NetworkedRacers : NetworkedRacer[];

var type : RaceStyle;

enum RMPhase{Loading,CutScene,RaceInfo,Countdown,RaceGUI,ScoreBoard,NextMenu};
var State = RMPhase.Loading;
...
State = RMPhase.NextMenu;
}

}
}

if(State == RMPhase.NextMenu){
...
if(type != RaceStyle.Online){
if(finishedPlayers == Players && State != RMPhase.NextMenu)
FinishRace();
}else{
if(Network.isServer){
