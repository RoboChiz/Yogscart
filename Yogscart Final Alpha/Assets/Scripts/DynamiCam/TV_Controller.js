...
cameras[currentCamera].transform.camera.depth = -depth;
cameras[currentCamera].transform.camera.enabled = false;
...
cameras[currentCamera].transform.camera.depth = depth;
cameras[currentCamera].transform.camera.enabled = true;
